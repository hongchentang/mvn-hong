 ...
 * 
 * 此标签依赖的文件
 * <script type="text/javascript" src="${contextPath}js/jquery-${version}.min.js"></script>
 ...
 * <p>============================================</p> 
 */
public class AjaxStoreDirective extends CmsCommonDirective implements TemplateDirectiveModel{
