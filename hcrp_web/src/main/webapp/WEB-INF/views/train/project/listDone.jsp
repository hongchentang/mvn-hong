...
<div style="margin: 5px;margin-bottom: 27px">
	<!-- <div class="easyui-panel" title="课程管理" style="width: 100%;" > -->
		<form id="listDoneForm" action="${ctx}/train/project/listDone.do" method="post">
			<div class="easyui-panel" title="" data-options="" style="width: 100%;">
				<div class="datagrid-toolbar" float:right>
					<table cellspacin="0" cellpadding="3px">
						<tr>
							...
							<td>
								<a href="javascript:void(0)" class="easyui-linkbutton" onclick="easyuiUtils.ajaxPostFormForPanel('listDoneForm','viewProjectListDone')" iconCls="fa fa-search">查询</a>
							</td>
						</tr>	
					</table>
					<table cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									<td><a onclick="showDetail_done()" href="javascript:void(0)" class="easyui-linkbutton">查看详细</a>	</td>
				...
				<div>
					...
					<jsp:include page="/jsp/common/include/manage_page_table.jsp">
						...
						<jsp:param value="viewProjectListDone" name="divId" />
					</jsp:include>
				</div>
			</div>
		</form>
			...
			$.ajax({
				...
				success:function(data){
					...
					if (parseInt(responseCode) == 200) {
						...
						jQuery("#viewProjectListDone").panel('refresh');
					} else {
