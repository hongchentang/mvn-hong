...
<div style="margin: 5px;margin-bottom: 27px">
		<form id="listProEditForm" action="${ctx}/train/project/listEdit.do" method="post">
...
<script>
function addPro(){
	openWindow('addProjectWindow','新增项目',0,600,'${ctx}/train/project/goAddProject.do?paramMap[rePanel]=viewProjectListEdit',true);
}
...
function editPro(){
	...
	var id = objects[0].id;
	openWindow('addProjectWindow','编辑项目',0,600,'${ctx}/train/project/goAddProject.do?id='+id+'&paramMap[rePanel]=viewProjectListEdit',true);
}
