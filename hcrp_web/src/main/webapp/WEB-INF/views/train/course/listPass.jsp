...
<div style="margin: 5px;margin-bottom: 27px">
	<!-- <div class="easyui-panel" title="课程管理" style="width: 100%;" > -->
		<form id="listIspassForm" action="${ctx}/train/course/listPass.do" method="post">
			<div class="easyui-panel" title="" data-options="" style="width: 100%;">
				<div class="datagrid-toolbar" float:right>
					<table cellspacin="0" cellpadding="3px">
						<tr>
							...
							<td>
								<a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:easyuiQuery('listIspassForm','viewListY');" iconCls="fa fa-search">查询</a>
							</td>
						...
						<table cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									<td><a onclick="showDetail_ispass_c()" href="javascript:void(0)" class="easyui-linkbutton">查看详细</a>	</td>
				...
				<div>
					<table id="listIspassTable" rownumbers="true" pagination="true" checkOnSelect="true" selectOnCheck="true" nowrap="true" singleSelect="true">
						<thead>
							<tr>
					...
					<jsp:include page="/jsp/common/include/manage_page_table.jsp">
						<jsp:param value="listIspassForm" name="pageForm" />
						<jsp:param value="listIspassTable" name="tableId" />
						<jsp:param value="easyui" name="type" />
						<jsp:param value="viewListY" name="divId" />
					</jsp:include>
				</div>
			</div>
		</form>
...
<script>
function showDetail_ispass_c(){
	var objects = $('#listIspassTable').datagrid('getSelections');
	if(objects.length == 0){
		...
		if(flag){
			$.ajax({
		        ...
		        success:function(data){		        					
					...
					jQuery("#viewListY").panel('refresh');
				}
			});
		}
	});
