...
<div style="margin: 5px;margin-bottom: 27px">
	<!-- <div class="easyui-panel" title="课程管理" style="width: 100%;" > -->
		<form id="listTrainCourseForm" action="${ctx}/train/course/listCourse.do?param[tabId]=${param['tabId']}" method="post">
			<div class="easyui-panel" title="" data-options="" style="width: 100%;">
				<div class="datagrid-toolbar" float:right>
					<table cellspacin="0" cellpadding="3px">
						<tr>
							...
							<td>
								<a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:easyuiUtils.ajaxPostFormForPanel(getCurrentTabComId('listTrainCourseForm',false),getCurrentTabId());" iconCls="fa fa-search">查询</a>
							</td>
						</tr>	
					</table>
				...
				<div>
					<table id="listTrainCourseTable" rownumbers="true" pagination="true" checkOnSelect="true" selectOnCheck="true" nowrap="true" singleSelect="true">
						<thead>
							<tr>
					...
					<jsp:include page="/jsp/common/include/manage_page_table.jsp">
						<jsp:param value="listTrainCourseForm" name="pageForm" />
						<jsp:param value="listTrainCourseTable" name="tableId" />
...
function showDetail_course(){
	var objects = $('#listTrainCourseTable').datagrid('getSelections');
	if(objects.length == 0){
...
function divideView_course(){
	...
	openWindow('divideViewWindow','分配教师',650,250,'${ctx}/train/courseTeacher/divideView.do?paramMap[trainCourseId]='+trainCourseId+'&paramMap[rePanel]=${param["tabId"]}',true);
