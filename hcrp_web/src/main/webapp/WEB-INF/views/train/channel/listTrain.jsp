...
<input type="hidden" name="paramMap[projectId]" value="${searchParam.paramMap.projectId }" id="projectId">
		...
		<div class="datagrid-toolbar" float:right>
			<table cellspacin="0" cellpadding="3px">
				<tr>
					...
					<td>
						<a href="javascript:void(0)" class="easyui-linkbutton" onclick="easyuiUtils.ajaxPostFormForPanel('listTrainForm','patentClassWindow')" iconCls="fa fa-search">查询</a>
					</td>
				</tr>	
			</table>
...
function addTrain(){
	...
	openWindow('addTrainWindow','新增培训班',0,600,'${ctx}/train/channel/goAddTrain.do?paramMap[projectId]='+projectId+'&paramMap[ids]='+ids+'&paramMap[names]='+names,true);
}
...
function editTrain(){
	...
	var id = objects[0].id;
	openWindow('addTrainWindow','编辑培训班',0,600,'${ctx}/train/channel/goAddTrain.do?id='+id+'&projectId=${searchParam.paramMap.projectId }',true);
}
