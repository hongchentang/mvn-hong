...
<!-- 专题专家上传附件 -->
 <form id="saveExpertFileFrom" name="saveExpertFileFrom" action="${ctx}/train/course/saveExpertFile.do" method="post" enctype="multipart/form-data">
			  	 ...
			  	 <td>操作</td>
			  		<td colspan="3">
				  		<div style="width: 70%;text-align: center;">
				  			<button type="button" onclick="uploadFile()" style="float: center; margin-right: 20px" class="easyui-linkbutton">
				            	添加
				            </button>
				            <button type="button" onclick="saveExpertFiel('saveExpertFileFrom')" style="float: center; margin-right: 20px" class="easyui-linkbutton">
				            	保存
				            </button>
				 		 </div>
			 		 </td>
...
function saveExpertFiel(formId){
