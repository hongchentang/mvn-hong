...
<div id="viewUserTopPanel" class="easyui-panel" data-options="" style="height:98%">
	<div id="viewUserTopListTabs" class="easyui-tabs" fit="true" data-options="tabPosition:'left',height:getHeight('viewUserTopPanel',100),cache:false">
		<div id="viewUserBaseTopTab" data-options="href:'${ctx}/common/user/student/${action}.do?id=${user.id}'" title="基本信息" ></div>
		<c:if test="${not empty user.id}">
			...
			<div id="viewUserHisTopTab" data-options="href:'${ctx}/common/user/student/listHis.do?paramMap[userId]=${user.id}'" title="修改历史" ></div>
