...
<form id="user_saveFrom" name="user_saveFrom" action="${ctx}/common/user/updateUserEmail.do" method="post">
	<table>
		...
		<input type="hidden" name="user.id" value="${user.id }" />
				...
				<tr>
				<td width="20%"><span style="color:red"></span>持有者姓名</td>
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.Name"  data-options="width: 200, height: 30" value="${user.name}" />
				</td>
