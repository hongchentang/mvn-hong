...
<form id="user_saveFrom" name="user_saveFrom" action="${ctx}/common/user/updateAll.do" method="post">
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.userName"  data-options="width: 200, height: 30, required:true" value="${user.userName}" readonly="readonly"  />
				...
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.userEmail" 
					  data-options="width: 200, height: 30, validType: 'email', required:true" value="${user.userEmail}"    />
				</td>
			</tr>
				<tr>
				<td width="20%"><span style="color:red">*</span>所属公司</td>
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.companyName"  data-options="width: 200, height: 30, required:true" value="${user.companyName}"  />
				</td>
				...
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.mobilePhoe"  data-options="width: 200, height: 30, required:true" value="${user.mobilePhoe}"/>
				</td>
