...
<div class="easyui-panel" id="saveDialogPanel" data-options="region:'center',title:''">
       <form id="moduleDialogSaveFrom"  action="${ctx}/common/security/module/save.do" method="post">
          	<table cellspacing="0" cellpadding="0" border="0" class="alter-table-v">
				<tbody>
					<tr>
				        ...
				        <td>
				        	<input class="easyui-textbox" type="text"  data-options="required:true" id="module.id" name="module.id"  type="text" />
				        </td>	
           			</tr>
		    		<tr>
		    			<td><label for="module.name">模块名称</label></td>
		    			<td>
		    				<input class="easyui-textbox" type="text"  id="id" name="module.name"  data-options="required:true" type="text" />
		  				</td>
		    		</tr>
		    		<tr>
		     		...
		     		<tr>
		     			...
		     			<td>
		     				<textarea class="easyui-validatebox" name="module.description" data-options="required:true" rows="3"></textarea>
		     			</td>
		     		</tr>
		     	</tbody>
		    </table>
...
<script type="text/javascript">
 ...
 function submitForm(){
	 ...
	 jQuery("#editDialog").find('#moduleDialogSaveFrom').form('submit', {   
