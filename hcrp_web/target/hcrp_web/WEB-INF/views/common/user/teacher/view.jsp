	...
	<div class="easyui-panel" title="师资信息" collapsible="true">
		...
		<tbody>
			<tr>
				<td width="20%">培训领域</td>
				<td width="30%">
					${userStaff.trainDomain}
				</td>
				<td width="20%">培训方向</td>
				<td width="30%">
					${userStaff.trainDirection}
				</td>
			</tr>
			...
			<tr>
				<td>主要学术著作及论文</td>
				<td>
					${userStaff.mainThesis}
				</td>
				<td>收款账号</td>
				<td>
					${userStaff.bankAccount}
				</td>
			</tr>
			<tr>
				<td>是否有知识产权教学或实务工作经验</td>
				<td colspan="3">
					${dict:getEntryName('HAVE_EXP',userStaff.haveExp) }
				</td>
			</tr>
			<tr>
				<td>从事知识产权教学或授课的相关经历</td>
				<td colspan="3">
					<textarea rows="2" style="width: 98%" readonly='readonly'>${userStaff.expDesc}</textarea>
				</td>
			</tr>
		</tbody>
		</table>
