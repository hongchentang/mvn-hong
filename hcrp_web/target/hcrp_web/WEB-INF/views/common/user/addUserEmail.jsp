...
<form id="user_saveFrom" name="user_saveFrom" action="${ctx}/common/user/newUserEmail.do" method="post">
	<table>
		...
		<tbody>
				...
				<td width="30%">
					<input type="text" class="easyui-textbox" name="user.Name"  data-options="width: 200, height: 30" />
				</td>
