                ...
                if (referrer != undefined && referrer != "" && referrer.indexOf(origin) > -1) {
                    ...
                    if (reg.test(pathName)) {
                        ...
                        if (value != null && value != homeItemTitle) {
                            ...
                            html += '&nbsp;<a href="/' + pathName + '" class="w-crumbs-item">' + value + '</a>';
                            $("#" + this.options.controlId + " .w-crumbs a:first").after(html);
...
+ function ($) {
    ...
    wzLeaveword = function () {
        ...
        this.checkPostData = function (data) {
            ...
            if ($.trim(data.Email) == "") {
                this.showError(this.options.$emailElement, this.options.emptyPrefix + data.emailPlaceHolder);
                return false;
            }
            //留言控件不在验证邮箱格式
            //else {
...
//针对图片控件的初始化
function InitNavImageSmv(controlId, width, styleHeight, fillType) {
    var $div = $("#div_" + controlId);
    var $control = $("#smv_" + controlId);
    var img = $("#img_smv_" + controlId);
    var $box = $div.find(".w-image-box");
