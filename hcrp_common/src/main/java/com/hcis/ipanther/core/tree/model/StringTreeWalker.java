 ...
 */
public class StringTreeWalker {
    private static Logger logger = Logger.getLogger(StringTreeWalker.class);
     ...
     */
    public StringTreeWalker(TreeModel treeModel) {
        try {
     ...
     */
    public String getParent(String childKey) {
     ...
     */
    public String getChild(String parentKey, int index) {
     ...
     */
    public String [] getChildren(String parentKey) {
    ...
    public void getAllChildren(String parentKey,List<String> list){
    	if(!this.isLeaf(parentKey)){
   	 		String[] childrens = this.getChildren(parentKey);
     ...
     */
    public int getIndexOfChild(String parentKey, String childKey) {
     ...
     */
    public String[] keys() {
        String [] k = new String[nextIndex-1];
     ...
     */
    private char findKey(String value, char startIndex) {
        if (startIndex == 0) {
            return 0;
        }

        if (keys[startIndex] .equals(value)) {
            return startIndex;
        }
     ...
     * depth.
     */
    private char findDepth(String value, char startIndex, int [] depth) {
        if (startIndex == 0) {
            return 0;
        }
     ...
     */
    private int fillDepthKeys(char startIndex, String [] depthKeys, int cursor) {
