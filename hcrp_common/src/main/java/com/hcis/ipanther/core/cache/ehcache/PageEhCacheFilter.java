 ...
 * @version 1.0
 */
public abstract class PageEhCacheFilter extends SimplePageCachingFilter {
    
    private final static Logger log = Logger.getLogger(PageEhCacheFilter.class);
       
    protected final static String FILTER_URL_PATTERNS = "patterns";
    protected static String[] cacheURLs;
    ...
    /**
     * 添加页面缓存逻辑验证，比如是否需要用户登录等
     * @param request
     * @return
     */
    protected abstract boolean isPageCache(final HttpServletRequest request);
}