...
public class JedisConnectionFactory implements InitializingBean, DisposableBean, RedisConnectionFactory {
	...
	private boolean redisSentinelAware = false;

	public void setRedisSentinelAware(boolean redisSentinelAware) {
		this.redisSentinelAware = redisSentinelAware;
	}
